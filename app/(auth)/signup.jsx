  ...
  return (
    <View className=" bg-[#161622] flex-1  h-full w-full items-center pt-[15%] "  >
      <View id='container' className =" h-fit w-[90%]">
          ...
          <TouchableOpacity onPress={()=>handleSignup(inputs.current.email,inputs.current.username,inputs.current.password)} className=" py-3 px-2  rounded-lg  flex justify-center items-center font-bold  text-[#161622] bg-[#ff8c00]">
